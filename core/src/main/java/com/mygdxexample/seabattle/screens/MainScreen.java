...
public class MainScreen implements Screen {
    ...
    public MainScreen(SeaBattleGame game) {
        ...
        Texture shadersTexture = new Texture(Gdx.files.internal(Assets.SHADERS_TEXTURE));
        backgroundTexture = new Texture(Gdx.files.internal(Assets.MENU_BACKGROUND));

        Image shadersButton = new Image(new TextureRegionDrawable(shadersTexture));
        ...
        Image startButton = new Image(new TextureRegionDrawable(startTexture));
        ...
        Image exitButton = new Image(new TextureRegionDrawable(exitTexture));
